...
const STRINGS = {
  ru: {
    ...
    paletteTabMonitoring: "Мониторинг",
    paletteTabObjects: "Объекты",
    ...
    groupKindPostgres: "PostgreSQL кластер",
    groupKindMysql: "MySQL кластер",
    groupKindOracle: "Oracle DB кластер",
    groupKindRedis: "Redis кластер",
    groupKindKafka: "Kafka кластер",
    groupKindMongodb: "MongoDB кластер",
    groupKindOpensearch: "OpenSearch кластер",
    groupKindClickhouse: "ClickHouse кластер",
    groupKindGenericCluster: "Self-managed кластер",
  ...
  en: {
    ...
    paletteTabMonitoring: "Monitoring",
    paletteTabObjects: "Objects",
    ...
    groupKindK8s: "Kubernetes Cluster",
    groupKindPostgres: "PostgreSQL Cluster",
    groupKindMysql: "MySQL Cluster",
    groupKindOracle: "Oracle DB Cluster",
    groupKindRedis: "Redis Cluster",
    groupKindKafka: "Kafka Cluster",
    groupKindMongodb: "MongoDB Cluster",
    groupKindOpensearch: "OpenSearch Cluster",
    groupKindClickhouse: "ClickHouse Cluster",
    groupKindGenericCluster: "Self-managed Cluster",
